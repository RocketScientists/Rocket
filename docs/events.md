...
|Show SearchBar by clicking MINI_URLBAR|action|show|search_bar|"mini_urlbar"|"orientation=portrait,landscape," 
...
|Show Logoman|action|show|logoman|""|"link=url,deeplink,null,message_id=message id," 
|Click Logoman|action|click|logoman|""|"link=url,deeplink,null,message_id=message id," 
|Swipe Logoman|action|swipe|logoman|""|"link=url,deeplink,null,message_id=message id," 
...
|Start Content Tab|action|start|content_tab|""|"feed=feed,source=source,category=category,component_id=component id,subcategory_id=subcategory id,version_id=version id," 
|End Content Tab|action|end|content_tab|""|"feed=feed,source=source,category=category,component_id=component id,subcategory_id=subcategory id,version_id=version,session_time=time duration from entering component,url_counts=url counts duration from entering component,app_link=open|install|null,show_keyboard=true|false," 
|Start Vertical Process|action|start|process|"vertical"|"" 
|End Vertical Process|action|end|process|"vertical"|"loadtime=[0-9]+," 
|Start Tab Swipe Process|action|start|process|"tab_swipe"|"" 
|End Tab Swipe Process|action|end|process|"tab_swipe"|"loadtime=[0-9]+," 
|Start Tab Swipe|action|start|tab_swipe|""|"feed=feed,source=source," 
|End Tab Swipe|action|end|tab_swipe|""|"feed=feed,source=source,session_time=time duration from entering component,url_counts=url counts duration from entering component,app_link=open|install|null,show_keyboard=true|false," 
|Click Toolbar - Share|action|click|toolbar|"share"|"mode=webview,position=[0-9],feed=feed,source=source,category=category,component_id=component id,subcategory_id=subcategory id,version_id=version id," 
|Click Toolbar - Reload|action|click|toolbar|"reload"|"mode=webview,position=[0-9],feed=feed,source=source,category=category,component_id=component id,subcategory_id=subcategory id,version_id=version id," 
|Click Toolbar - Back|action|click|toolbar|"back"|"mode=webview,position=[0-9],feed=feed,source=source,category=category,component_id=component id,subcategory_id=subcategory id,version_id=version id," 
|Click Toolbar - Tab Swipe|action|click|toolbar|"tab_swipe"|"from=home,tab_swipe," 
|Show Tab Swipe Drawer|action|show|drawer|"tab_swipe"|"feed=feed," 
|Click Tab Swipe Drawer|action|click|drawer|"tab_swipe"|"feed=feed," 
|Add Tab Swipe Tab|action|add|tab|"tab_swipe"|"" 
|Change Tab Swipe Settings|action|change|setting|"tab_swipe"|"feed=feed," 
|Show SearchBar from Tab Swipe|action|show|search_bar|"tab_swipe"|"" 
|Show Keyboard from Tab Swipe SearchBar|action|show_keyboard|search_bar|"tab_swipe"|"" 
|Start Typing from Tab Swipe SearchBar|action|start_typing|search_bar|"tab_swipe"|"" 
|Search with text in SearchBar|action|type_query|search_bar|"tab_swipe"|"" 
|Use SearchSuggestion in Tab Swipe SearchBar|action|select_query|search_bar|"tab_swipe"|"default=true,false,keyword=default name xxx,null," 
